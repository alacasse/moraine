...
Point de départ Git : `5feab54` (sources, expériences A/B/C, revues et plan). Le pilote est une extraction distincte; il n'importe pas les modules des expériences et ne modifie pas leurs fichiers.

...
| Consultation permise avec exclusions; écriture et envoi bloqués avec autorisations ciblées | Modèle hybride proposé par l'utilisateur le 23 septembre; périmètres, priorités et effets à préciser, aucun défaut produit adopté |
...
### Proposition hybride du 23 septembre : exclusions en lecture, autorisations en écriture
...
la personne. Ce sont des défauts proposés, pas une configuration adoptée.
...
La dernière proposition est un modèle hybride : consultation autorisée avec
exclusions, écriture et envoi bloqués avec autorisations ciblées. Ses priorités
et le parcours après blocage restent à discuter.
